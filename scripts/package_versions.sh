...
export CMAKE_LOCATION="http://www.cmake.org/files/v2.8/"
export CMAKEVERSION_REQUIRED=cmake-2.8.6
export CMAKEVERSION=cmake-2.8.12.2
...
export G4EMLOW_VERSION=G4EMLOW6.35
export G4EMLOW_TAR=G4EMLOW.6.35.tar.gz

export G4ENSDFSTATE_VERSION=G4ENSDFSTATE1.0
export G4ENSDFSTATE_TAR=G4ENSDFSTATE.1.0.tar.gz

export G4NDL_VERSION=G4NDL4.4
export G4NDL_TAR=G4NDL.4.4.tar.gz
...
export PhotonEvaporation_VERSION=PhotonEvaporation3.0
export PhotonEvaporation_TAR=G4PhotonEvaporation.3.0.tar.gz

export RadioactiveDecay_VERSION=RadioactiveDecay4.0
export RadioactiveDecay_TAR=G4RadioactiveDecay.4.0.tar.gz
