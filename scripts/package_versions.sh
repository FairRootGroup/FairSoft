...
export G4ENSDFSTATE_VERSION=G4ENSDFSTATE2.1
export G4ENSDFSTATE_TAR=G4ENSDFSTATE2.1.tar.gz
...
export G4SAIDDATA_VERSION=G4SAIDDATA2.2
export G4SAIDDATA_TAR=G4SAIDDATA.2.2.tar.gz

export PhotonEvaporation_VERSION=G4PhotonEvaporation5.2
export PhotonEvaporation_TAR=G4PhotonEvaporation.5.2.tar.gz

export RadioactiveDecay_VERSION=G4RadioactiveDecay5.2
...
export FAIRLOGGER_VERSION=v1.1.0

export FAIRMQ_LOCATION="https://github.com/FairRootGroup/FairMQ"
export FAIRMQ_VERSION=v1.2.0
