...
#    version('10.03.p03', '2248ad436613897d9fad93bdb99d9446', expand=False)
    ...
    depends_on("g4ndl@4.5", when='@10.03')
    depends_on("g4neutronxs@1.4", when='@10.03')
    depends_on("g4saiddata@1.1", when='@10.03')
    depends_on("g4ensdfstate@2.1", when='@10.03')
    depends_on("g4photonevaporation@4.3.2", when='@10.03')
    depends_on("g4pii@1.3", when='@10.03')
    depends_on("g4radioactivedecay@5.1.1", when='@10.03')
    depends_on("g4realsurface@1.0", when='@10.03')
    depends_on("g4tendl@1.3", when='@10.03')
    # geant4@10.04
    ...
    # geant4@10.05.p01
    depends_on("g4ndl@4.5", when='@10.05')
    depends_on("g4emlow@7.7", when='@10.05')
    depends_on("g4photonevaporation@5.3", when='@10.05')
    depends_on("g4radioactivedecay@5.3", when='@10.05')
    depends_on("g4saiddata@2.0", when='@10.05')
    depends_on("g4particlexs@1.1", when='@10.05')
    depends_on("g4abla@3.1", when='@10.05')
    depends_on("g4incl@1.0", when='@10.05')
    depends_on("g4pii@1.3", when='@10.05')
