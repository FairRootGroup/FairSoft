...
if (NOT PACKAGE_SET STREQUAL fairmqdev)
  ...
  ExternalProject_Add(fairmq
    ...
    ${CMAKE_DEFAULT_ARGS} CMAKE_ARGS
      ...
      "-DBUILD_SDK=ON"
    DEPENDS asio boost dds fairlogger flatbuffers zeromq ${extract_source_cache_target}
    ${LOG_TO_FILE}
  )

  list(APPEND packages odc)
  set(odc_version "0.38")
