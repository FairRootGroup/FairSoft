...
dnf -y install \
    ...
    grpc-plugins gsl-devel gzip help2man hostname htop hwloc-devel joe libX11-devel libXau-devel \
    ...
    libunistring-devel libuuid-devel libxml2-devel libzstd-devel lz4-devel m4 make mesa-libGL-devel \
    mesa-libGLU-devel ncdu ncurses-devel openblas-devel openssl-devel patch procps protobuf-devel python \
    python-devel python3-numpy python3-pygments python3-pyyaml readline-devel \
